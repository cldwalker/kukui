...
lt.plugins.kukui.text__GT_tags = (function text__GT_tags(text){return cljs.core.map.call(null,(function (p1__9398_SHARP_){return cljs.core.subs.call(null,p1__9398_SHARP_,1);
...
*/
lt.plugins.kukui.__GT_tagged_nodes = (function __GT_tagged_nodes(ed,lines){return new cljs.core.Keyword(null,"nodes","nodes",1118897699).cljs$core$IFn$_invoke$arity$1(cljs.core.reduce.call(null,(function (accum,p__9404){var vec__9405 = p__9404;var curr = cljs.core.nth.call(null,vec__9405,0,null);var next = cljs.core.nth.call(null,vec__9405,1,null);if(cljs.core.truth_(lt.plugins.kukui.parent_node_QMARK_.call(null,curr,next)))
{return cljs.core.update_in.call(null,accum,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tags","tags",1017456523)], null),(function (p1__9400_SHARP_){return lt.plugins.kukui.add_node_with_tags.call(null,cljs.core.remove.call(null,(function (tag){return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"indent","indent",4124632094).cljs$core$IFn$_invoke$arity$1(tag),new cljs.core.Keyword(null,"indent","indent",4124632094).cljs$core$IFn$_invoke$arity$1(curr));
}),p1__9400_SHARP_),curr,lt.plugins.kukui.text__GT_tags.call(null,new cljs.core.Keyword(null,"text","text",1017460895).cljs$core$IFn$_invoke$arity$1(curr)));
}));
} else
...
}),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"tags","tags",1017456523),cljs.core.PersistentHashSet.EMPTY,new cljs.core.Keyword(null,"nodes","nodes",1118897699),cljs.core.PersistentVector.EMPTY], null),cljs.core.partition.call(null,2,1,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__9399_SHARP_){return cljs.core.PersistentHashMap.fromArrays.call(null,[new cljs.core.Keyword(null,"line","line",1017226086),new cljs.core.Keyword(null,"indent","indent",4124632094),new cljs.core.Keyword(null,"text","text",1017460895)],[p1__9399_SHARP_,lt.plugins.sacha.codemirror.line_indent.call(null,ed,p1__9399_SHARP_),lt.objs.editor.line.call(null,ed,p1__9399_SHARP_)]);
}),lines))));
});
/**
...
;
lt.plugins.kukui.types_counts = (function types_counts(ed,lines){var nodes = lt.plugins.kukui.ed__GT_nodes.call(null,ed,lines);var types_config = lt.plugins.kukui.dynamic_config.call(null,nodes);return cljs.core.map.call(null,(function (p1__9411_SHARP_){return (new cljs.core.PersistentVector(null,2,5,cljs.core.PersistentVector.EMPTY_NODE,[p1__9411_SHARP_,lt.plugins.kukui.type_counts.call(null,cljs.core.get_in.call(null,types_config,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"types","types",1124748267),p1__9411_SHARP_], null)),nodes)],null));
...
lt.plugins.kukui.type_map = cljs.core.partial.call(null,lt.plugins.kukui.type_nodes__GT_tag_map,(function (p1__9412_SHARP_,p2__9413_SHARP_,p3__9414_SHARP_){return cljs.core.update_in.call(null,p1__9412_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p2__9413_SHARP_], null),cljs.core.fnil.call(null,cljs.core.conj,cljs.core.PersistentVector.EMPTY),p3__9414_SHARP_);
}));
...
lt.plugins.kukui.indent_nodes = (function indent_nodes(nodes,indent,tab_size,offset_level){var offset = (offset_level * tab_size);var tag_indent = (indent + offset);var node_indent = ((indent + offset) + tab_size);var desc_indent = (((indent + offset) + tab_size) + tab_size);return cljs.core.mapcat.call(null,(function (p1__9415_SHARP_){if(cljs.core.truth_(new cljs.core.Keyword(null,"type-tag","type-tag",4631398905).cljs$core$IFn$_invoke$arity$1(p1__9415_SHARP_)))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str(cljs.core.apply.call(null,cljs.core.str,cljs.core.repeat.call(null,tag_indent," "))),cljs.core.str(new cljs.core.Keyword(null,"text","text",1017460895).cljs$core$IFn$_invoke$arity$1(p1__9415_SHARP_))].join('')], null);
} else
{return cljs.core.into.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [lt.plugins.kukui.indent_node.call(null,p1__9415_SHARP_,node_indent)], null),cljs.core.map.call(null,(function (x){return lt.plugins.kukui.indent_node.call(null,x,desc_indent);
}),new cljs.core.Keyword(null,"desc","desc",1016984067).cljs$core$IFn$_invoke$arity$1(p1__9415_SHARP_)));
}
}),nodes);
});
/**
...
return (function (p__9434){var vec__9435 = p__9434;var node = cljs.core.nth.call(null,vec__9435,0,null);var c = cljs.core.nth.call(null,vec__9435,1,null);if((c > 1))
{return node;
} else
{return null;
}
...
return (function (p1__9417_SHARP_){return cljs.core.first.call(null,cljs.core.apply.call(null,cljs.core.max_key,((function (freqs,dups){
return (function (p__9436){var vec__9437 = p__9436;var tag = cljs.core.nth.call(null,vec__9437,0,null);var nodes = cljs.core.nth.call(null,vec__9437,1,null);if(cljs.core.truth_(cljs.core.set.call(null,p1__9417_SHARP_).call(null,tag)))
...
return (function (p1__9418_SHARP_){return (new cljs.core.PersistentVector(null,2,5,cljs.core.PersistentVector.EMPTY_NODE,[most_popular_tag.call(null,new cljs.core.Keyword(null,"tags","tags",1017456523).cljs$core$IFn$_invoke$arity$1(p1__9418_SHARP_)),p1__9418_SHARP_],null));
...
return (function (p__9438){var vec__9439 = p__9438;var allowed_tag = cljs.core.nth.call(null,vec__9439,0,null);var dup_node = cljs.core.nth.call(null,vec__9439,1,null);return (cljs.core._EQ_.call(null,dup_node,node)) && (cljs.core.not_EQ_.call(null,allowed_tag,tag));
});})(freqs,dups,most_popular_tag,tag_dups))
,tag_dups);
});})(freqs,dups,most_popular_tag,tag_dups))
;var seq__9440_9451 = cljs.core.seq.call(null,tag_dups);var chunk__9441_9452 = null;var count__9442_9453 = 0;var i__9443_9454 = 0;while(true){
if((i__9443_9454 < count__9442_9453))
{var vec__9444_9455 = cljs.core._nth.call(null,chunk__9441_9452,i__9443_9454);var tag_9456 = cljs.core.nth.call(null,vec__9444_9455,0,null);var node_9457 = cljs.core.nth.call(null,vec__9444_9455,1,null);cljs.core.println.call(null,[cljs.core.str("Line '"),cljs.core.str(new cljs.core.Keyword(null,"text","text",1017460895).cljs$core$IFn$_invoke$arity$1(node_9457)),cljs.core.str("' has overlapping tags. Put line under "),cljs.core.str(lt.plugins.kukui.tag_prefix),cljs.core.str(tag_9456)].join(''));
{
var G__9458 = seq__9440_9451;
var G__9459 = chunk__9441_9452;
var G__9460 = count__9442_9453;
var G__9461 = (i__9443_9454 + 1);
seq__9440_9451 = G__9458;
chunk__9441_9452 = G__9459;
count__9442_9453 = G__9460;
i__9443_9454 = G__9461;
continue;
}
} else
{var temp__4126__auto___9462 = cljs.core.seq.call(null,seq__9440_9451);if(temp__4126__auto___9462)
{var seq__9440_9463__$1 = temp__4126__auto___9462;if(cljs.core.chunked_seq_QMARK_.call(null,seq__9440_9463__$1))
{var c__7561__auto___9464 = cljs.core.chunk_first.call(null,seq__9440_9463__$1);{
var G__9465 = cljs.core.chunk_rest.call(null,seq__9440_9463__$1);
var G__9466 = c__7561__auto___9464;
var G__9467 = cljs.core.count.call(null,c__7561__auto___9464);
var G__9468 = 0;
seq__9440_9451 = G__9465;
chunk__9441_9452 = G__9466;
count__9442_9453 = G__9467;
i__9443_9454 = G__9468;
continue;
}
} else
{var vec__9445_9469 = cljs.core.first.call(null,seq__9440_9463__$1);var tag_9470 = cljs.core.nth.call(null,vec__9445_9469,0,null);var node_9471 = cljs.core.nth.call(null,vec__9445_9469,1,null);cljs.core.println.call(null,[cljs.core.str("Line '"),cljs.core.str(new cljs.core.Keyword(null,"text","text",1017460895).cljs$core$IFn$_invoke$arity$1(node_9471)),cljs.core.str("' has overlapping tags. Put line under "),cljs.core.str(lt.plugins.kukui.tag_prefix),cljs.core.str(tag_9470)].join(''));
{
var G__9472 = cljs.core.next.call(null,seq__9440_9463__$1);
var G__9473 = null;
var G__9474 = 0;
var G__9475 = 0;
seq__9440_9451 = G__9472;
chunk__9441_9452 = G__9473;
count__9442_9453 = G__9474;
i__9443_9454 = G__9475;
continue;
}
}
} else
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.keep.call(null,(function (p__9446){var vec__9447 = p__9446;var tag = cljs.core.nth.call(null,vec__9447,0,null);var nodes = cljs.core.nth.call(null,vec__9447,1,null);var new_nodes = cljs.core.remove.call(null,(function (p1__9419_SHARP_){return disallowed_node_QMARK_.call(null,p1__9419_SHARP_,tag);
...
;
lt.plugins.kukui.type_selector = lt.plugins.kukui.selector.selector.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"items","items",1114430258),(function (){return cljs.core.map.call(null,(function (p1__9448_SHARP_){return cljs.core.PersistentHashMap.fromArrays.call(null,[new cljs.core.Keyword(null,"name","name",1017277949)],[cljs.core.name.call(null,p1__9448_SHARP_)]);
...
var tags_string = cljs.core.get.call(null,cljs.core.re_find.call(null,/^\s*(\S+:|)\s*(.*)$/,query),2);var tags = (cljs.core.truth_(tags_string)?clojure.string.split.call(null,tags_string,/\s*,\s*/):null);var tags__$1 = cljs.core.mapcat.call(null,cljs.core.partial.call(null,lt.plugins.kukui.expand_tag,lt.plugins.kukui.config),tags);var view_config = __GT_view_fn.call(null,tags__$1);return lt.plugins.kukui.__GT_view.call(null,ed,view_config,indent_level);
});
...
return (function (p1__9449_SHARP_){return cljs.core.PersistentHashMap.fromArrays.call(null,[new cljs.core.Keyword(null,"names","names",1118489274),new cljs.core.Keyword(null,"default","default",2558708147)],[cljs.core.conj.call(null,p1__9449_SHARP_,"leftover"),"leftover"]);
});})(ed,line,end_line))
...
return (function (p1__9450_SHARP_){return cljs.core.PersistentHashMap.fromArrays.call(null,[new cljs.core.Keyword(null,"names","names",1118489274)],[p1__9450_SHARP_]);
