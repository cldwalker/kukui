...
lt.plugins.kukui.text__GT_tags = (function text__GT_tags(text){return cljs.core.map.call(null,(function (p1__11378_SHARP_){return cljs.core.subs.call(null,p1__11378_SHARP_,1);
...
*/
lt.plugins.kukui.__GT_tagged_nodes = (function __GT_tagged_nodes(ed,lines){return new cljs.core.Keyword(null,"nodes","nodes",1118897699).cljs$core$IFn$_invoke$arity$1(cljs.core.reduce.call(null,(function (accum,p__11384){var vec__11385 = p__11384;var curr = cljs.core.nth.call(null,vec__11385,0,null);var next = cljs.core.nth.call(null,vec__11385,1,null);if(cljs.core.truth_(lt.plugins.kukui.parent_node_QMARK_.call(null,curr,next)))
{return cljs.core.update_in.call(null,accum,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tags","tags",1017456523)], null),(function (p1__11380_SHARP_){return lt.plugins.kukui.add_node_with_tags.call(null,cljs.core.remove.call(null,(function (tag){return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"indent","indent",4124632094).cljs$core$IFn$_invoke$arity$1(tag),new cljs.core.Keyword(null,"indent","indent",4124632094).cljs$core$IFn$_invoke$arity$1(curr));
}),p1__11380_SHARP_),curr,lt.plugins.kukui.text__GT_tags.call(null,new cljs.core.Keyword(null,"text","text",1017460895).cljs$core$IFn$_invoke$arity$1(curr)));
}));
} else
...
}),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"tags","tags",1017456523),cljs.core.PersistentHashSet.EMPTY,new cljs.core.Keyword(null,"nodes","nodes",1118897699),cljs.core.PersistentVector.EMPTY], null),cljs.core.partition.call(null,2,1,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__11379_SHARP_){return cljs.core.PersistentHashMap.fromArrays.call(null,[new cljs.core.Keyword(null,"line","line",1017226086),new cljs.core.Keyword(null,"indent","indent",4124632094),new cljs.core.Keyword(null,"text","text",1017460895)],[p1__11379_SHARP_,lt.plugins.sacha.codemirror.line_indent.call(null,ed,p1__11379_SHARP_),lt.objs.editor.line.call(null,ed,p1__11379_SHARP_)]);
}),lines))));
});
/**
...
;
lt.plugins.kukui.types_counts = (function types_counts(ed,lines){var nodes = lt.plugins.kukui.ed__GT_nodes.call(null,ed,lines);var types_config = lt.plugins.kukui.dynamic_config.call(null,nodes);return cljs.core.map.call(null,(function (p1__11391_SHARP_){return (new cljs.core.PersistentVector(null,2,5,cljs.core.PersistentVector.EMPTY_NODE,[p1__11391_SHARP_,lt.plugins.kukui.type_counts.call(null,cljs.core.get_in.call(null,types_config,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"types","types",1124748267),p1__11391_SHARP_], null)),nodes)],null));
...
lt.plugins.kukui.type_map = cljs.core.partial.call(null,lt.plugins.kukui.type_nodes__GT_tag_map,(function (p1__11392_SHARP_,p2__11393_SHARP_,p3__11394_SHARP_){return cljs.core.update_in.call(null,p1__11392_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p2__11393_SHARP_], null),cljs.core.fnil.call(null,cljs.core.conj,cljs.core.PersistentVector.EMPTY),p3__11394_SHARP_);
}));
...
lt.plugins.kukui.indent_nodes = (function indent_nodes(nodes,indent,tab_size,offset_level){var offset = (offset_level * tab_size);var tag_indent = (indent + offset);var node_indent = ((indent + offset) + tab_size);var desc_indent = (((indent + offset) + tab_size) + tab_size);return cljs.core.mapcat.call(null,(function (p1__11395_SHARP_){if(cljs.core.truth_(new cljs.core.Keyword(null,"type-tag","type-tag",4631398905).cljs$core$IFn$_invoke$arity$1(p1__11395_SHARP_)))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str(cljs.core.apply.call(null,cljs.core.str,cljs.core.repeat.call(null,tag_indent," "))),cljs.core.str(new cljs.core.Keyword(null,"text","text",1017460895).cljs$core$IFn$_invoke$arity$1(p1__11395_SHARP_))].join('')], null);
} else
{return cljs.core.into.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [lt.plugins.kukui.indent_node.call(null,p1__11395_SHARP_,node_indent)], null),cljs.core.map.call(null,(function (x){return lt.plugins.kukui.indent_node.call(null,x,desc_indent);
}),new cljs.core.Keyword(null,"desc","desc",1016984067).cljs$core$IFn$_invoke$arity$1(p1__11395_SHARP_)));
}
}),nodes);
});
/**
...
return (function (p__11414){var vec__11415 = p__11414;var node = cljs.core.nth.call(null,vec__11415,0,null);var c = cljs.core.nth.call(null,vec__11415,1,null);if((c > 1))
{return node;
} else
{return null;
}
...
return (function (p1__11397_SHARP_){return cljs.core.first.call(null,cljs.core.apply.call(null,cljs.core.max_key,((function (freqs,dups){
return (function (p__11416){var vec__11417 = p__11416;var tag = cljs.core.nth.call(null,vec__11417,0,null);var nodes = cljs.core.nth.call(null,vec__11417,1,null);if(cljs.core.truth_(cljs.core.set.call(null,p1__11397_SHARP_).call(null,tag)))
...
return (function (p1__11398_SHARP_){return (new cljs.core.PersistentVector(null,2,5,cljs.core.PersistentVector.EMPTY_NODE,[most_popular_tag.call(null,new cljs.core.Keyword(null,"tags","tags",1017456523).cljs$core$IFn$_invoke$arity$1(p1__11398_SHARP_)),p1__11398_SHARP_],null));
...
return (function (p__11418){var vec__11419 = p__11418;var allowed_tag = cljs.core.nth.call(null,vec__11419,0,null);var dup_node = cljs.core.nth.call(null,vec__11419,1,null);return (cljs.core._EQ_.call(null,dup_node,node)) && (cljs.core.not_EQ_.call(null,allowed_tag,tag));
});})(freqs,dups,most_popular_tag,tag_dups))
,tag_dups);
});})(freqs,dups,most_popular_tag,tag_dups))
;var seq__11420_11440 = cljs.core.seq.call(null,tag_dups);var chunk__11421_11441 = null;var count__11422_11442 = 0;var i__11423_11443 = 0;while(true){
if((i__11423_11443 < count__11422_11442))
{var vec__11424_11444 = cljs.core._nth.call(null,chunk__11421_11441,i__11423_11443);var tag_11445 = cljs.core.nth.call(null,vec__11424_11444,0,null);var node_11446 = cljs.core.nth.call(null,vec__11424_11444,1,null);cljs.core.println.call(null,[cljs.core.str("Line '"),cljs.core.str(new cljs.core.Keyword(null,"text","text",1017460895).cljs$core$IFn$_invoke$arity$1(node_11446)),cljs.core.str("' has overlapping tags. Put line under "),cljs.core.str(lt.plugins.kukui.tag_prefix),cljs.core.str(tag_11445)].join(''));
{
var G__11447 = seq__11420_11440;
var G__11448 = chunk__11421_11441;
var G__11449 = count__11422_11442;
var G__11450 = (i__11423_11443 + 1);
seq__11420_11440 = G__11447;
chunk__11421_11441 = G__11448;
count__11422_11442 = G__11449;
i__11423_11443 = G__11450;
continue;
}
} else
{var temp__4126__auto___11451 = cljs.core.seq.call(null,seq__11420_11440);if(temp__4126__auto___11451)
{var seq__11420_11452__$1 = temp__4126__auto___11451;if(cljs.core.chunked_seq_QMARK_.call(null,seq__11420_11452__$1))
{var c__7580__auto___11453 = cljs.core.chunk_first.call(null,seq__11420_11452__$1);{
var G__11454 = cljs.core.chunk_rest.call(null,seq__11420_11452__$1);
var G__11455 = c__7580__auto___11453;
var G__11456 = cljs.core.count.call(null,c__7580__auto___11453);
var G__11457 = 0;
seq__11420_11440 = G__11454;
chunk__11421_11441 = G__11455;
count__11422_11442 = G__11456;
i__11423_11443 = G__11457;
continue;
}
} else
{var vec__11425_11458 = cljs.core.first.call(null,seq__11420_11452__$1);var tag_11459 = cljs.core.nth.call(null,vec__11425_11458,0,null);var node_11460 = cljs.core.nth.call(null,vec__11425_11458,1,null);cljs.core.println.call(null,[cljs.core.str("Line '"),cljs.core.str(new cljs.core.Keyword(null,"text","text",1017460895).cljs$core$IFn$_invoke$arity$1(node_11460)),cljs.core.str("' has overlapping tags. Put line under "),cljs.core.str(lt.plugins.kukui.tag_prefix),cljs.core.str(tag_11459)].join(''));
{
var G__11461 = cljs.core.next.call(null,seq__11420_11452__$1);
var G__11462 = null;
var G__11463 = 0;
var G__11464 = 0;
seq__11420_11440 = G__11461;
chunk__11421_11441 = G__11462;
count__11422_11442 = G__11463;
i__11423_11443 = G__11464;
continue;
}
}
} else
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.keep.call(null,(function (p__11426){var vec__11427 = p__11426;var tag = cljs.core.nth.call(null,vec__11427,0,null);var nodes = cljs.core.nth.call(null,vec__11427,1,null);var new_nodes = cljs.core.remove.call(null,(function (p1__11399_SHARP_){return disallowed_node_QMARK_.call(null,p1__11399_SHARP_,tag);
...
var __GT_view__delegate = function (ed,type_or_view,p__11429){var map__11431 = p__11429;var map__11431__$1 = ((cljs.core.seq_QMARK_.call(null,map__11431))?cljs.core.apply.call(null,cljs.core.hash_map,map__11431):map__11431);var opts = map__11431__$1;var query_tag = cljs.core.get.call(null,map__11431__$1,new cljs.core.Keyword(null,"query-tag","query-tag",3500842119));var level = cljs.core.get.call(null,map__11431__$1,new cljs.core.Keyword(null,"level","level",1116770038),1);var nodes = lt.plugins.kukui.ed__GT_nodes.call(null,ed);var nodes__$1 = (cljs.core.truth_(query_tag)?cljs.core.filter.call(null,((function (nodes){
return (function (p1__11428_SHARP_){return cljs.core.contains_QMARK_.call(null,cljs.core.set.call(null,new cljs.core.Keyword(null,"tags","tags",1017456523).cljs$core$IFn$_invoke$arity$1(p1__11428_SHARP_)),query_tag);
});})(nodes))
...
__GT_view.cljs$lang$applyTo = (function (arglist__11465){
var ed = cljs.core.first(arglist__11465);
arglist__11465 = cljs.core.next(arglist__11465);
var type_or_view = cljs.core.first(arglist__11465);
var p__11429 = cljs.core.rest(arglist__11465);
...
;
lt.plugins.kukui.type_selector = lt.plugins.kukui.selector.selector.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"items","items",1114430258),(function (){return cljs.core.map.call(null,(function (p1__11432_SHARP_){return cljs.core.PersistentHashMap.fromArrays.call(null,[new cljs.core.Keyword(null,"name","name",1017277949)],[cljs.core.name.call(null,p1__11432_SHARP_)]);
...
var __GT_query_view__delegate = function (ed,query,p__11434){var map__11437 = p__11434;var map__11437__$1 = ((cljs.core.seq_QMARK_.call(null,map__11437))?cljs.core.apply.call(null,cljs.core.hash_map,map__11437):map__11437);var types_config = cljs.core.get.call(null,map__11437__$1,new cljs.core.Keyword(null,"types-config","types-config",4798725768));var view_fn = cljs.core.get.call(null,map__11437__$1,new cljs.core.Keyword(null,"view-fn","view-fn",1468084322),((function (map__11437,map__11437__$1,types_config){
return (function (p1__11433_SHARP_){return cljs.core.PersistentHashMap.fromArrays.call(null,[new cljs.core.Keyword(null,"names","names",1118489274)],[p1__11433_SHARP_]);
});})(map__11437,map__11437__$1,types_config))
);var level = cljs.core.get.call(null,map__11437__$1,new cljs.core.Keyword(null,"level","level",1116770038),1);if(cljs.core.seq.call(null,query))
{} else
...
return (function (p1__11439_SHARP_){return cljs.core.PersistentHashMap.fromArrays.call(null,[new cljs.core.Keyword(null,"names","names",1118489274),new cljs.core.Keyword(null,"default","default",2558708147)],[cljs.core.conj.call(null,p1__11439_SHARP_,"leftover"),"leftover"]);
});})(ed,line,end_line))
